...
using QrTailor.Application;
using QrTailor.Infrastructure;
using QrTailor.Persistance;
...
app.UseCors(builder => builder.WithOrigins("https://qrtailor.vercel.app", "http://localhost:3000", "http://localhost:4200", "http://localhost").AllowAnyHeader().AllowAnyMethod());
